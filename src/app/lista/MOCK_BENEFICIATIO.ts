    ...
    requerimento: [
      {
        ...
        status: 'Processada',
        acoes: ['Detalhar', 'Analisar', 'Historico', 'Cancelar'],
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'ANTONIO PEREIRA PINTO',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Transferencia de Assentamento',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'Ana Clara Barbosa',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Altualização de unidade familiar',
        perfilDoSolicitante: 'Conjuge',
        status: 'Processada com pendencias',
        acoes: ['Detalhar', 'Analisar', 'Historico', 'Cancelar'],
        detalhar: 'Documentação completa; aguardando validação.',
      },
    ],
    ...
    requerimento: [
      {
        ...
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Atualização de situação',
        perfilDoSolicitante: 'Incra',
        status: 'Deferido',
        acoes: ['Detalhar', 'Analisar', 'Historico', 'Cancelar'],
        detalhar: 'Documentação completa; aguardando validação.',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'MARIA DAS DORES BEZERRA DA SILVA',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Atualização de dados pessoais',
        perfilDoSolicitante: 'Beneficiário',
        status: 'Indeferido',
        acoes: ['Detalhar', 'Analisar', 'Historico', 'Cancelar'],
        detalhar: 'Documentação completa; aguardando validação.',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'ODACIR CARLOS DAS CHAGAS',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Desbloqueio',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'RAUL GUILHERME SILVA DE AMORIM',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Transferencia de Assentamento',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'JOSE APARECIDO DIAS DOS SANTOS',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Altualização de unidade familiar',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'RAIMUNDO DE JESUS SOUZA DE LIMA',
        sr: '',
        uf: '',
        projetoAssentamento: '',
        tipoDeServico: 'Atualização de dados pessoais',
    ...
    requerimento: [
      {
        ...
        cpfBeneficiario: '000.000.000-00',
        nomeBeneficiario: '',
        solicitante: 'DOMINGOS DOS SANTOS SILVA',
        sr: 'SR-04',
        uf: 'RS',
        projetoAssentamento: '',
        tipoDeServico: 'Atualização de situação',
